+++
    ...
    date = 2019-05-23T10:16:08-07:00 #the date the file was created
...
<div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="yoga_frame.jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="dirty_computer_album.jpg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="metropolis_album.jpg" class="d-block w-100" alt="...">
              </div>
            </div>
